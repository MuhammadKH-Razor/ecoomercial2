...
import './shops2.css';
import logo1 from '../assets/images/news/Untitled-022.png';
import moc1 from '../assets/images/news/moc1.jpg';
import moc2 from '../assets/images/news/moc2.jpg';
import moc3 from '../assets/images/news/moc3.jpg';
...
class Shops2 extends React.Component {
    ...
    componentDidMount = async () => {
        ...
        if (this.state.emailUser.length) {
            console.log('email saya:', this.state.emailUser)
        }

        console.log('data:', dataUserLogins)
    }
    ...
    cekOngkir = (e) => {
        ...
        fetch("http://localhost:4000/api/cek_ongkir", {
            ...
            .then((res) => {
                ...
                console.log('ongkir', this.state.valueOngkir)
            })
            .catch((err) => {
                console.log(404);
            });
    ...
    render() {
        const { slideFull, slideFull2, slideFull3, valueChange, valueChangeOngkir, foodMenu, drinkMenu, catalogMenu, hatsMenu, shortMenu, healtMenu, getPriceAll, deletes, cekOngkir, cekOngkir2, tikiPos, openPay, closePay, errorPay, payMidtrans, dealPayMistrans, sendEmail } = this;
        const { categoryMenu, kategori, alamat, checkListOrder, orderListValue, foto, emailUser, dataUsers, alamatTambahan, kurir, kota, valueOngkir, isCheckPaypal, payStatus } = this.state;
            ...
            <div>
                <div className="sec-parent">
                    ...
                    <section className="sec-1a" id="sec-a">
                        ...
                        <h2 className="text-title1-spes">Paket porsi spesial</h2>
                        <h5 className="text-title2-spes">Tidak sama dan tetap enak</h5>
                        <div className="body-spesial">
                            <div className="wrap-spesial">
                                <div className="spes">
                                    <div className="page-prod">
                                        <img src={food1} alt="" />
                                    </div>
                                    <div className="content-prod">
                                        <h6>Promo akhir tahun 2020 untuk kamu yang di rumah</h6>
                                        <small>Paket limited</small>
                                    </div>
                                </div>
                                <div className="spes">
                                    <div className="page-prod">
                                        ...
                                        return (
                                            <div className="order" key={index}>
                                                ...
                                                <div className="details-order">
                                                    ...
                                                    <p className="price-orders">{data.value}</p>
                                                </div>
                                            </div>
                                        )
                                    })
